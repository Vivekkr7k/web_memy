  ...
  return (
    <div class="max-w-2xl mx-auto">
      <div class="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm transition-all divide-purple-400 ease-in-out">
        ...
        <div class="p-5 ">
          <a href="#">
            <h5 class=" font-bold text-2xl tracking-tight mb-2  ">
          ...
          <a
            href="#"
            class=" bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            Read more
            <svg
