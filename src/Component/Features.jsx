...
const Features = () => {
  return (
	...
	<div className="container mx-auto p-4 my-6 space-y-2 text-center">
		<h2 className="text-5xl font-bold">"Unlocking Excellence: Explore Our Features <span className='text-blue-900'>!</span>"</h2>
		<p className="dark:text-gray-400">Discover the Power Behind Our Features</p>
	</div>
